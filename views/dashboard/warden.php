...
<div class="dashboard-grid">
    ...
    <div class="card" onclick="location.href='index.php?page=laundry'">Laundry</div>
    <div class="card" onclick="location.href='index.php?page=bathroom'">Bathroom Cleaning</div>
    <div class="card" onclick="location.href='index.php?page=timing'">Timing</div>
