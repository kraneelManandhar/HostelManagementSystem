...
<head>
    ...
    <title>Manager Single Rooms - Pentatonic Hostel</title>
    ...
    <div class="mr-body-row">
        <aside class="mr-sidebar">
            ...
            <nav class="mr-sidebar-nav">
                ...
                <a class="mr-nav-btn active" href="<?= $baseUrl ?>index.php?action=manager_rooms_single"><i class="ph ph-bed"></i><span>Rooms</span></a>
                    ...
                    <div class="mr-room-links">
                        <?php foreach ($singleRooms as $room): ?>
                            <a
                                ...
                                href="<?= $baseUrl ?>index.php?action=manager_rooms_single&room_id=<?= (int) $room['id'] ?>"
                            >
