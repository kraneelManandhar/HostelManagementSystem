...
<head>
    ...
    <title>Manager Double Rooms - Pentatonic Hostel</title>
    ...
    <div class="mr-body-row">
        <aside class="mr-sidebar">
            ...
            <nav class="mr-sidebar-nav">
                <a class="mr-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_dashboard"><i class="ph-fill ph-squares-four"></i><span>Dashboard</span></a>
                <a class="mr-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_students"><i class="ph ph-student"></i><span>Students</span></a>
                <a class="mr-nav-btn active" href="<?= $baseUrl ?>index.php?action=manager_rooms_double"><i class="ph ph-bed"></i><span>Rooms</span></a>
                <a class="mr-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_fees"><i class="ph ph-money"></i><span>Fees</span></a>
                <a class="mr-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_complaints"><i class="ph ph-megaphone"></i><span>Complaints</span></a>
                <a class="mr-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_notices"><i class="ph ph-warning"></i><span>Notice</span></a>
                <a class="mr-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_staff"><i class="ph ph-users-three"></i><span>Staffs</span></a>
            </nav>
                    ...
                    <div class="mr-room-links">
                        <?php foreach ($doubleRooms as $room): ?>
                            <a
                                ...
                                href="<?= $baseUrl ?>index.php?action=manager_rooms_double&room_id=<?= (int) $room['id'] ?>"
                            >
