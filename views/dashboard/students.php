...
function managerRedirect(string $baseUrl, ?int $selectedId = null): void
{
    $target = $baseUrl . 'index.php?action=manager_students';
    if ($selectedId) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($formAction === 'edit') {
        ...
        managerRedirect($baseUrl, $studentId);
    }
...
<head>
    ...
    <title>Manager Students - Pentatonic Hostel</title>
    ...
    <div class="ms-body-row">
        <aside class="ms-sidebar">
            ...
            <nav class="ms-sidebar-nav">
                <a class="ms-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_dashboard">
                    <i class="ph-fill ph-squares-four"></i>
                    <span>Dashboard</span>
                </a>
                <a class="ms-nav-btn active" href="<?= $baseUrl ?>index.php?action=manager_students">
                    <i class="ph ph-student"></i>
                    <span>Students</span>
                </a>
                <a class="ms-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_rooms_single"><i class="ph ph-bed"></i><span>Rooms</span></a>
                <a class="ms-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_fees"><i class="ph ph-money"></i><span>Fees</span></a>
                <a class="ms-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_complaints"><i class="ph ph-megaphone"></i><span>Complaints</span></a>
                <a class="ms-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_notices"><i class="ph ph-warning"></i><span>Notice</span></a>
                <a class="ms-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_staff"><i class="ph ph-users-three"></i><span>Staffs</span></a>
            </nav>
                    ...
                    <div class="ms-student-list">
                        <?php foreach ($students as $studentItem): ?>
                            ...
                            <a
                                ...
                                href="<?= $baseUrl ?>index.php?action=manager_students&student_id=<?= (int) $studentItem['id'] ?>"
                            >
                ...
                <section class="ms-right">
                    <div class="ms-toolbar">
                        ...
                        <form method="get" action="<?= $baseUrl ?>index.php">
                            <input type="hidden" name="action" value="manager_students">
