...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: ' . $baseUrl . 'index.php?action=manager_notices');
    exit;
}
...
<head>
    ...
    <title>Manager Notices - Pentatonic Hostel</title>
    ...
    <div class="mn-body-row">
        <aside class="mn-sidebar">
            ...
            <nav class="mn-sidebar-nav">
                <a class="mn-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_dashboard"><i class="ph-fill ph-squares-four"></i><span>Dashboard</span></a>
                <a class="mn-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_students"><i class="ph ph-student"></i><span>Students</span></a>
                <a class="mn-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_rooms_single"><i class="ph ph-bed"></i><span>Rooms</span></a>
                <a class="mn-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_fees"><i class="ph ph-money"></i><span>Fees</span></a>
                <a class="mn-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_complaints"><i class="ph ph-megaphone"></i><span>Complaints</span></a>
                <a class="mn-nav-btn active" href="<?= $baseUrl ?>index.php?action=manager_notices"><i class="ph ph-warning"></i><span>Notice</span></a>
                <a class="mn-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_staff"><i class="ph ph-users-three"></i><span>Staffs</span></a>
            </nav>
        ...
        <main class="mn-main">
                ...
                <div class="mn-modal-wrap">
                    ...
                    <form method="post">
                        ...
                        <div class="mn-form-footer">
                            <a class="mn-back-link" href="<?= $baseUrl ?>index.php?action=manager_notices">
            ...
            <?php else: ?>
                ...
                <section class="mn-panel">
                    <a class="mn-open-btn" href="<?= $baseUrl ?>index.php?action=manager_notices&form=1">Post notice +</a>
                        ...
                        <?php foreach ($notices as $notice): ?>
                            <div class="mn-card">
                                ...
                                <div class="mn-card-actions">
                                    ...
                                    <a class="mn-edit-link" href="<?= $baseUrl ?>index.php?action=manager_notices&edit_id=<?= (int) $notice['id'] ?>">Edit</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
