...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $redirectUrl = $baseUrl . 'index.php?action=manager_complaints';
...
<head>
    ...
    <title>Manager Complaints - Pentatonic Hostel</title>
    ...
    <div class="mc-body-row">
        <aside class="mc-sidebar">
            ...
            <nav class="mc-sidebar-nav">
                <a class="mc-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_dashboard"><i class="ph-fill ph-squares-four"></i><span>Dashboard</span></a>
                <a class="mc-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_students"><i class="ph ph-student"></i><span>Students</span></a>
                <a class="mc-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_rooms_single"><i class="ph ph-bed"></i><span>Rooms</span></a>
                <a class="mc-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_fees"><i class="ph ph-money"></i><span>Fees</span></a>
                <a class="mc-nav-btn active" href="<?= $baseUrl ?>index.php?action=manager_complaints"><i class="ph ph-megaphone"></i><span>Complaints</span></a>
                <a class="mc-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_notices"><i class="ph ph-warning"></i><span>Notice</span></a>
                <a class="mc-nav-btn" href="<?= $baseUrl ?>index.php?action=manager_staff"><i class="ph ph-users-three"></i><span>Staffs</span></a>
            </nav>
        ...
        <main class="mc-main">
            ...
            <div class="mc-toolbar">
                ...
                <form class="mc-filter" method="get" action="<?= $baseUrl ?>index.php">
                    <input type="hidden" name="action" value="manager_complaints">
